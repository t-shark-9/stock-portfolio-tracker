...
const initialStocks = [
    ...
    { id: 5, owner: 'tjark', wkn: 'A14Y6F', name: 'Shopify', amount: 3, buyPrice: 169.04, currentPrice: 169.04, category: 'value', sector: 'technology' },
    { id: 6, owner: 'tjark', wkn: 'A0YJQ2', name: 'Intuitive Surgical', amount: 3, buyPrice: 409.70, currentPrice: 409.70, category: 'growth', sector: 'technology' },
    { id: 7, owner: 'tjark', wkn: 'A1KWPQ', name: 'Visa', amount: 8, buyPrice: 55.41, currentPrice: 55.41, category: 'value', sector: 'finance' },
    { id: 8, owner: 'tjark', wkn: 'A2T0VU', name: 'CrowdStrike', amount: 6, buyPrice: 54.20, currentPrice: 54.20, category: 'growth', sector: 'technology' },
    { id: 9, owner: 'tjark', wkn: 'A2AT0H', name: 'Snap Inc', amount: 2, buyPrice: 18.00, currentPrice: 18.00, category: 'value', sector: 'consumer' },
    { id: 10, owner: 'tjark', wkn: '871970', name: 'TUI', amount: 30, buyPrice: 1.64, currentPrice: 1.64, category: 'value', sector: 'industrial' },
    { id: 11, owner: 'tjark', wkn: 'A143D6', name: 'Etsy', amount: 1, buyPrice: 55.00, currentPrice: 55.00, category: 'growth', sector: 'technology' },
    { id: 12, owner: 'tjark', wkn: 'A3DQXS', name: 'Snowflake', amount: 1, buyPrice: 167.50, currentPrice: 167.50, category: 'growth', sector: 'technology' },
    { id: 13, owner: 'tjark', wkn: 'A3C4QT', name: 'Palantir', amount: 1, buyPrice: 40.20, currentPrice: 40.20, category: 'growth', sector: 'technology' },
    { id: 14, owner: 'tjark', wkn: '602224', name: 'Henkel', amount: 1, buyPrice: 77.12, currentPrice: 77.12, category: 'value', sector: 'consumer' },
    { id: 15, owner: 'tjark', wkn: 'A3C7R6', name: 'Datadog', amount: 1, buyPrice: 46.85, currentPrice: 46.85, category: 'growth', sector: 'technology' },
    { id: 16, owner: 'tjark', wkn: 'A12B6J', name: 'PayPal', amount: 1, buyPrice: 180.14, currentPrice: 180.14, category: 'growth', sector: 'finance' },
    { id: 17, owner: 'tjark', wkn: '908063', name: 'Nike', amount: 6, buyPrice: 77.42, currentPrice: 77.42, category: 'value', sector: 'consumer' },
    { id: 18, owner: 'tjark', wkn: 'A41FLM', name: 'IonQ', amount: 5, buyPrice: 9.35, currentPrice: 9.35, category: 'growth', sector: 'technology' },
    { id: 19, owner: 'tjark', wkn: 'A3EU6F', name: 'Cloudflare', amount: 1, buyPrice: 53.19, currentPrice: 53.19, category: 'growth', sector: 'technology' },
    { id: 20, owner: 'tjark', wkn: 'PAG911', name: 'Penske Automotive', amount: 1, buyPrice: 42.43, currentPrice: 42.43, category: 'value', sector: 'industrial' },
    { id: 21, owner: 'tjark', wkn: 'A3C47B', name: 'SoFi', amount: 3, buyPrice: 13.36, currentPrice: 13.36, category: 'growth', sector: 'technology' },
    ...
    { id: 23, owner: 'matthias', wkn: 'A2JG9Z', name: 'MercadoLibre', amount: 4, buyPrice: 280.00, currentPrice: 280.00, category: 'growth', sector: 'technology' },
    { id: 24, owner: 'matthias', wkn: 'A0M4W9', name: 'Emerging Markets ETF', amount: 26, buyPrice: 9.71, currentPrice: 9.71, category: 'value', sector: 'etf' },
    { id: 25, owner: 'matthias', wkn: '694482', name: 'Siemens', amount: 9, buyPrice: 28.60, currentPrice: 28.60, category: 'value', sector: 'industrial' },
    { id: 26, owner: 'matthias', wkn: '851399', name: "McDonald's", amount: 4, buyPrice: 250.00, currentPrice: 250.00, category: 'value', sector: 'consumer' },
    ...
    { id: 28, owner: 'matthias', wkn: 'A1H5UP', name: 'Uber', amount: 8, buyPrice: 30.56, currentPrice: 30.56, category: 'growth', sector: 'technology' },
    { id: 29, owner: 'matthias', wkn: 'A0YERL', name: 'Gilead Sciences', amount: 3, buyPrice: 101.00, currentPrice: 101.00, category: 'value', sector: 'healthcare' },
    { id: 30, owner: 'matthias', wkn: 'A14WK0', name: 'Adobe', amount: 1, buyPrice: 374.30, currentPrice: 374.30, category: 'growth', sector: 'technology' },
    { id: 31, owner: 'matthias', wkn: 'A0ETBQ', name: 'ASML', amount: 10, buyPrice: 216.75, currentPrice: 216.75, category: 'growth', sector: 'technology' },
    { id: 32, owner: 'matthias', wkn: 'A2N5NR', name: 'Vanguard EM ETF', amount: 25, buyPrice: 10.08, currentPrice: 10.08, category: 'value', sector: 'etf' },
    { id: 33, owner: 'matthias', wkn: 'A0DLEV', name: 'Russell 2000 ETF', amount: 11, buyPrice: 23.26, currentPrice: 23.26, category: 'value', sector: 'etf' },
    { id: 34, owner: 'matthias', wkn: 'A4009U', name: 'Rivian', amount: 18, buyPrice: 14.70, currentPrice: 14.70, category: 'growth', sector: 'technology' },
    { id: 35, owner: 'matthias', wkn: 'A2JNY1', name: 'NIO', amount: 67, buyPrice: 3.75, currentPrice: 3.75, category: 'growth', sector: 'other' },
    { id: 36, owner: 'matthias', wkn: 'A2QBX7', name: 'Coupang', amount: 18, buyPrice: 14.25, currentPrice: 14.25, category: 'growth', sector: 'technology' },
    { id: 37, owner: 'matthias', wkn: 'DBX1DA', name: 'S&P 500 ETF', amount: 8, buyPrice: 232.70, currentPrice: 232.70, category: 'value', sector: 'etf' },
    { id: 38, owner: 'matthias', wkn: 'DBX0SV', name: 'Total Market ETF', amount: 707, buyPrice: 11.29, currentPrice: 11.29, category: 'value', sector: 'etf' },
];
